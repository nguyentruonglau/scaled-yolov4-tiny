...
class CocoEvalidation():
    def __init__(self, groundtruth_boxes,groundtruth_classes,groundtruth_valids,class_names):
        ...
        self.groundtruth_dict = self.convert_gt_to_coco(
          groundtruth_boxes,groundtruth_classes,groundtruth_valids,class_names)
    ...
    def convert_gt_to_coco(self, groundtruth_boxes,groundtruth_classes,groundtruth_valids,class_names):
        ...
        if num_imgs == 0:
            raise ValueError('[ERROR]: The number of groundtruth_boxes must be greater than zero.')
        coco_groundtruth = []
        image_export_list = []
    ...
    def get_coco_mAP(self,detection_boxes,detection_scores,detection_classes,detection_valids):
        detections_list = self.convert_detection_to_coco(detection_boxes, 
          detection_scores, detection_classes, detection_valids)
